# Release Validation — 1.3.0-dev.17
...
- twenty-message S3/R2 healthy-path batching with one-message failure replay;
- bounded parallel S3/R2 canonical metadata and catalog shard prefetch;
