...
(function run() {
  ...
  assert.strictEqual(sandbox.__BACKUP_CONFIG.VERSION, '1.3.0-dev.21');
  ...
  assert.strictEqual(sandbox.GmailBackupLibrary.version(), '1.3.0-dev.21');
  ...
  assert.strictEqual(machineStatus.exporterVersion, '1.3.0-dev.21');
  assert.strictEqual(
