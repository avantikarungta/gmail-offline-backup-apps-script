...
(function run() {
  ...
  assert.strictEqual(sandbox.__BACKUP_CONFIG.VERSION, '1.3.0-dev.29');
  ...
  assert.strictEqual(sandbox.__BACKUP_CONFIG.S3_MAX_PARALLEL_BYTES, 1 * 1024 * 1024);
  ...
  assert.strictEqual(sandbox.GmailBackupLibrary.version(), '1.3.0-dev.29');
  ...
  assert.strictEqual(machineStatus.exporterVersion, '1.3.0-dev.29');
  assert.strictEqual(
