...
For S3-compatible storage, a new range contains at most 64 messages. That range
...
waves instead of serial shard operations. A range that fails before commit is
