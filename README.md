...
Fresh S3/R2 APPLY transactions are capped at 32 messages after the live
64-message transaction exceeded the Apps Script V8 heap. Independent upload
...
S3/R2 APPLY groups up to 32 messages into one durable transaction and reads or
